...
# Simple Pod Type Identifier
# Identifies whether a pod is running Quarkus or Spring Boot
...
identify_pod() {
    ...
    log_verbose "Annotations: $annotations"
    ...
    if [[ "$annotations" == *"springboot"* ]]; then
        echo "springboot"
        return
    fi
